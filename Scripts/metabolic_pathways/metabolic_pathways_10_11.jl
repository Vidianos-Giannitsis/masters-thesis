...
init_st2310_1 = (sucrose = df2310_1_conc.Sucrose[1], glucose = df2310_1_conc.Glucose[1],
                 fructose = df2310_1_conc.Fructose[1], lactate = df2310_1_conc.Lactate[7],
                 acetate = df2310_1_conc.Acetate[7], propionate = df2310_1_conc.Propionate[7],
                 ethanol = df2310_1_conc.Ethanol[6], co2 = 0.0, hydrogen = 0.0, water = 750.0,
                 pyruvate = 0.0, succinate = 0.0, acetaldehyde = 0.0, butyrate = 0.0)
...
init_st2310_2 = (sucrose = df2310_2_conc.Sucrose[1], glucose = df2310_2_conc.Glucose[1],
            fructose = df2310_2_conc.Fructose[1], lactate = df2310_2_conc.Lactate[2],
            acetate = df2310_2_conc.Acetate[2], propionate = df2310_2_conc.Propionate[2],
            ethanol = df2310_2_conc.Ethanol[2], co2 = 0.0, hydrogen = 0.0, water = 750.0,
            pyruvate = 0.0, succinate = 0.0, acetaldehyde = 0.0, butyrate = 0.0)
