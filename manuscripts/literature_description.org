...
The effect of ethanol in AD folder, solid-state fermentation folder, maybe three stage fermentation folder, and maybe pretreatment cost folder. As much of them as deemed necessary.

Τα αρχεία στα sub-folders του Multi-stage AD στο zotero, sorted ανάλογα με το topic.

Ίσως κάποιο άλλο από τα άρθρα που έχω στο reading list για acidogenic SSF μπας και το κάνουμε πιο πλούσιο σε βιβλιογραφία. Επίσης, πιθανόν άρθρα αν κρίνω ότι κάποιο κομμάτι θέλει περισσότερη βιβλιογραφία για να το αιτιολογήσω. Ένα που έχω δει τώρα είναι ίσως κάποια άλλη προσπάθεια να μειώσουμε την ποσότητα ενζύμων που χρειάζονται στην υδρόλυση για μείωση του κόστους πέρα από την χρήση μιξ με μικροοργανισμούς και τους υπέρηχους. Επίσης, ψάξιμο πιθανόν για άρθρα που λένε ότι χρησιμοποιήσαν SSF λόγω του χαμηλότερου κόστους. Ίσως κάποιο από αυτά που είχα δει για αιθανόλη ή αυτά από το acidogenic, ίσως κάτι καινούργιο.
