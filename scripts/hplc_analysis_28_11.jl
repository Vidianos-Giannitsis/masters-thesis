...
df0_area = CSV.read(datadir("exp_raw/hplc_area_28_11_0.csv"), DataFrame)
create_conc_table(df0_area, datadir("exp_pro/hplc_conc_28_11_0.csv"))
df0_conc = CSV.read(datadir("exp_pro/hplc_conc_28_11_0.csv"), DataFrame)

df1_area = CSV.read(datadir("exp_raw/hplc_area_28_11_1.csv"), DataFrame)
create_conc_table(df1_area, datadir("exp_pro/hplc_conc_28_11_1.csv"))
df1_conc = CSV.read(datadir("exp_pro/hplc_conc_28_11_1.csv"), DataFrame)

df2_area = CSV.read(datadir("exp_raw/hplc_area_28_11_2.csv"), DataFrame)
create_conc_table(df2_area, datadir("exp_pro/hplc_conc_28_11_2.csv"))
df2_conc = CSV.read(datadir("exp_pro/hplc_conc_28_11_2.csv"), DataFrame)

df4_area = CSV.read(datadir("exp_raw/hplc_area_28_11_4.csv"), DataFrame)
create_conc_table(df4_area, datadir("exp_pro/hplc_conc_28_11_4.csv"))
df4_conc = CSV.read(datadir("exp_pro/hplc_conc_28_11_4.csv"), DataFrame)

df8_area = CSV.read(datadir("exp_raw/hplc_area_28_11_8.csv"), DataFrame)
create_conc_table(df8_area, datadir("exp_pro/hplc_conc_28_11_8.csv"))
...
savefig(suc_groupedbar, plotsdir("28_11/sucrose_bar_28_11.png"))
...
savefig(gluc_groupedbar, plotsdir("28_11/glucose_bar_28_11.png"))
...
savefig(fruc_groupedbar, plotsdir("28_11/fructose_bar_28_11.png"))
...
savefig(lact_groupedbar, plotsdir("28_11/lactate_bar_28_11.png"))
...
savefig(ac_groupedbar, plotsdir("28_11/acetate_bar_28_11.png"))
...
savefig(prop_groupedbar, plotsdir("28_11/propionate_bar_28_11.png"))
...
savefig(eth_groupedbar, plotsdir("28_11/ethanol_bar_28_11.png"))
...
savefig(pH_groupedbar, plotsdir("28_11/pH_bar_28_11.png"))
...
savefig(grouped_bar_final, plotsdir("28_11/grouped_bar_final_28_11.png"))
...
conc_groupedbar_0 = groupedbar(t, [df0_conc.Sucrose df0_conc.Glucose df0_conc.Fructose df0_conc.Lactate df0_conc.Acetate df0_conc.Propionate df0_conc.Ethanol],
                         ...
                         markersize = 6)
savefig(conc_groupedbar_0, plotsdir("28_11/conc_groupedbar_0_28_11.png"))
...
conc_groupedbar_1 = groupedbar(t, [df1_conc.Sucrose df1_conc.Glucose df1_conc.Fructose df1_conc.Lactate df1_conc.Acetate df1_conc.Propionate df1_conc.Ethanol],
                         ...
                         markersize = 6)
savefig(conc_groupedbar_1, plotsdir("28_11/conc_groupedbar_1_28_11.png"))
...
savefig(conc_groupedbar_2, plotsdir("28_11/conc_groupedbar_2_28_11.png"))
...
conc_groupedbar_4 = groupedbar(t, [df4_conc.Sucrose df4_conc.Glucose df4_conc.Fructose df4_conc.Lactate df4_conc.Acetate df4_conc.Propionate df4_conc.Ethanol],
                         ...
                         markersize = 6)
savefig(conc_groupedbar_4, plotsdir("28_11/conc_groupedbar_4_28_11.png"))
...
conc_groupedbar_8 = groupedbar(t, [df8_conc.Sucrose df8_conc.Glucose df8_conc.Fructose df8_conc.Lactate df8_conc.Acetate df8_conc.Propionate df8_conc.Ethanol],
                         ...
                         markersize = 6, legend = :top)
savefig(conc_groupedbar_8, plotsdir("28_11/conc_groupedbar_8_28_11.png"))
...
savefig(conc_groupedbar, plotsdir("28_11/conc_groupedbar_28_11.png"))

# Comparison plots with previous experiments
...
savefig(sucrose_red_bar, plotsdir("28_11/sucrose_red_bar_28_11.png"))
...
savefig(glucose_red_bar, plotsdir("28_11/glucose_red_bar_28_11.png"))
...
fructose_red_bar = groupedbar(t, [df0_fructose_red df1_fructose_red df2_fructose_red df4_fructose_red df8_fructose_red], label = plot_label,
                          ...
                          ylims = (0, 100))
savefig(fructose_red_bar, plotsdir("28_11/fructose_red_bar_28_11.png"))

sugar_red_bar = plot(sucrose_red_bar, fructose_red_bar, glucose_red_bar, layout = (3,1), size = (900, 600))
savefig(sugar_red_bar, plotsdir("28_11/sugar_red_bar_28_11.png"))
