...
cod_meas = CSV.read(datadir("exp_pro/cod_28_11.csv"), DataFrame)
...
cod0_plot = bar(mix_amount, [cod0_meas cod0_theor],
                ...
                xticks = [0, 1, 2, 4, 8])
savefig(cod0_plot, plotsdir("28_11/cod_comparison_28_11_0.png"))
...
cod72_plot = bar(mix_amount, [cod72_meas cod72_theor],
                ...
                ylabel = "COD (g/l)", legend=:bottom,
                 ...
                 xticks = [0, 1, 2, 4, 8])
savefig(cod72_plot, plotsdir("28_11/cod_comparison_28_11_72.png"))

cod_plot = plot(cod0_plot, cod72_plot, layout = (2,1), size = (900, 600))
savefig(cod_plot, plotsdir("28_11/cod_comparison_28_11.png"))
