...
#+NAME: alternate_deps
#+BEGIN_SRC julia :noweb no-export ../scripts/alternative_hypothesis_testing.jl
...
#+BEGIN_SRC julia :noweb no-export :tangle ../scripts/alternate_hypothesis_testing.jl
